...
| [`fuzz-yml-ci-summary-gap.md`](runbooks/fuzz-yml-ci-summary-gap.md) | Ready-to-apply diff adding a structured CI-observability summary to `fuzz.yml` — blocked on `workflows` permission (tracked in #3316). |
