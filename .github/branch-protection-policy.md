...
```bash
gh api -X PUT "repos/kubestellar/console-kb/branches/main/protection" --input policy.json
```
...
Addresses security findings tracked in issue #2794 (branch protection) and #2795 (mandatory code review).
