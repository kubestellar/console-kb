...
1. **GitHub Security Advisories** — open a private report at:
   https://github.com/kubestellar/console-kb/security/advisories/new
...
- You have a question about how to use a fix or runbook (use [Slack](https://cloud-native.slack.com/archives/C097094RZ3M) instead)
- The issue is in the KubeStellar Console itself rather than in community-contributed mission content (report in [kubestellar/console](https://github.com/kubestellar/console/security/advisories/new))
